...
class TestKauppa(unittest.TestCase):
    ...
    def test_useamman_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_useamman_saman_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdaan ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
    ...
    def test_useamman_ostosten_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_jos_toista_tuotetta_ei_ole_varastossa(self):
        # tehdaan ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
